...
Download this repository to your computer and open any  `index(1..10).html` from the `pages` folder or [here](http://127.0.0.1:5500/pages/index1.html) with any browser and click button `Читать`. Have fun reading!
...
```
4. Open any `index(1..10).html` from the `pages` folder or [here](http://127.0.0.1:5500/pages/index1.html) with any browser and click button `Читать`.
